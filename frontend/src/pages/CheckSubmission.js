...
function CheckSubmission() {
  ...
  return (
    ...
    <div className="max-w-3xl mx-auto p-6 mt-10 bg-white rounded shadow">
      <h2 className="text-3xl font-bold mb-4">Check Submission</h2>
      <p className="text-gray-700">Details and submissions for Hunt ID: <span className="font-mono">{huntId}</span></p>
      {/* Add your submission list/UI here */}
    </div>
    </LayoutWrapper>
  );
}
