...
//     >
//       <div>
//         <h2 className="text-xl font-bold text-[#9112BC] mb-3">
//           {title}
//         </h2>
...
//       <span className="mt-6 text-[#9112BC] font-semibold">
//         Open →
//       </span>
//     </div>
//   );
...
//       <div className="mt-8">
//         <span className="inline-block bg-[#9112BC] text-white px-6 py-3 rounded-xl font-semibold">
//           Explore
//         </span>
//       </div>
//     </div>
